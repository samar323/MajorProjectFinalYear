...
<jsp:include page="TeacherNavBar.jsp" /> 
    ...
    <header>
        <div class="first">
            ...
            <h3 style="text-align: right;"><a href="#" id="button"><button type="button" class="btn btn-primary">Create Class <i
                        class="fa fa-plus-circle" aria-hidden="true"></i></button></a></h3>
        </div>
    </header>
    <%
...
%>
                <li class="card">
                    <div class="up">
                        ...
                        <div class="content">
                            <a href="AddAssignment.jsp?aid=<%=assignmentclass.get("aid") %>" class="click-btn"></a>
                            <h2 class="text">
                            <a class="text-link">
                                <div class="class-link"><%=assignmentclass.get("className") %></div>
                                <div class="subject"><%=assignmentclass.get("subject") %></div>
                                
                            </a>
                        </h2>
                        <div class="name-div">
                            <div class="name"><%=teacherDetails.get("name") %></div>
                        </div>
                        </div>
                    </div>
			...
			if(photo!=null){
			%>
			 <img src='GetPhoto?email=<%=teacherDetails.get("email")%>&type=teacher' class="user-pic" width="100px">
		<%
			}else{
				%>
		...
		%>
                    ...
                    <div class="down">
                        <div class="delete">
                            <a href="DeleteClass?id=<%=assignmentclass.get("aid")%>" class="delete-btn">
                                <span>
        ...
        <div class="containerpop">
            ...
            <div class="titlepop">Create Class</div>
                <div class="contentpop">
                    <form action="AddAssignmentClass" method="post">
                        <div class="user-detailspop">
                            <div class="input-boxpop">
                                <span class="detailspop">Class Name</span>
                                <input type="text" name="class" placeholder="B.Tech(IT) 4A" required>
                            </div>
                            <div class="input-boxpop">
                                <span class="detailspop">Subject</span>
                                <input type="text" name="subject" placeholder="IT 301" required>
                            </div>
                            <div class="button">
